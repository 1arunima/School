...
import { FaChartBar, FaUserGraduate, FaBook, FaSignOutAlt } from "react-icons/fa";
...
const  Staffsidebar= () => {
  ...
  const Menus = [
    ...
    { title: "Student Details", icon: <FaUserGraduate />, path: "/studentdetails" },
    { title: "Book Details", icon: <FaBook />, path: "/fetchbook" },
  ];
