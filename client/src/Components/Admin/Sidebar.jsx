...
import { FaChartBar, FaUsers, FaBook, FaUserGraduate, FaSignOutAlt } from "react-icons/fa";

const SidebarMenu = () => {
  const [open, setOpen] = useState(true);

  // Menu items definition with the new sections and Logout
  const Menus = [
    { title: "Dashboard", icon: <FaChartBar />, path: "/dashboard" },
    { title: "Staff Details", icon: <FaUsers />, path: "/staffDetails" },
    { title: "Books Management", icon: <FaBook />, path: "/fetchbook" },
    { title: "Student Info", icon: <FaUserGraduate />, path: "/adminstudetails" },
  ];
